<script>
    ...
    onMount(() => {
        safeContent = sanitizeHtml(data.sertifikasi.deskripsi_sertifikasi);
    });
...
<div class="max-w-4xl mx-auto my-8 p-6 bg-white shadow-lg rounded-lg border border-gray-200">
    <p class="text-5xl font-bold text-center text-black mb-4">{data.sertifikasi.nama_sertifikasi}</p>
